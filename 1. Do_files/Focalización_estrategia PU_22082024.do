...
collapse (first) departamento provincia distrito (count) co_hogar (sum) tag hogar_critico Pobreza_ serv_0 serv_1a4 serv_5a9 v_0 v_1 v_2 v_3  prior_1 prior_2 prior_3 prior_4, by (ubigeo)
